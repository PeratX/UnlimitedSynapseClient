...
class SynapseClient extends Thread{
	...
	public function __construct(\ClassLoader $loader, $port, $interface = "127.0.0.1"){
	...
	public function run(){
		...
		try{
			$socket = new SynapseSocket($this->port, $this->interface);
	...
	public function errorHandler($errno, $errstr, $errfile, $errline, $context, $trace = null){
		...
		Logger::debug("An $errno error happened: \"$errstr\" in \"$errfile\" at line $errline");
